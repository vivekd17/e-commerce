    ...
    <div className='productdisplay'>
      ...
      <div className="productdisplay-right">
        ...
        <div className="productdisplay-right-stars">
            <img src={star_fill} alt="" /> {/* Replace (*) with star img */}
        ...
        <div className="productdisplay-right-description">
          A lightweight, usually knitted, pullover shirt, close-fitting and winter a round neckline and short sleeves, worn as an undershirt or outer grarment.
        </div>
